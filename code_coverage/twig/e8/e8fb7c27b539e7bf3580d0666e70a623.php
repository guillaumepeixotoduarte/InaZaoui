...
class __TwigTemplate_d454b749a458f3f1293daf6cbb195ed6 extends Template
{
    ...
    ";
        ...
        ";
        // line 13
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "active", [], "any", false, false, false, 13), 'row');
        yield "
...
";
    ...
    {
        return array (  110 => 15,  105 => 13,  101 => 12,  97 => 11,  93 => 10,  89 => 9,  85 => 8,  80 => 6,  76 => 4,  63 => 3,  40 => 1,);
    }
...
{% block admin %}
    <div class=\"d-flex justify-content-between align-items-center\">
        <h1>Invités</h1>
        <a href=\"{{ path(\x27admin_user_index\x27) }}\" class=\"btn btn-primary\">Retour</a>
    </div>
    {{ form_start(form) }}
        {{ form_row(form.name) }}
        ...
        <button type=\"submit\" class=\"btn btn-primary\">Ajouter</button>
    {{ form_end(form) }}
{% endblock %}", "admin/user/add.html.twig", "C:\\wamp64\\www\\876-p15-inazaoui-main\\templates\\admin\\user\\add.html.twig");
    }
}
